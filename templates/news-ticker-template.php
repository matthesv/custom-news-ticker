...
<div class="news-ticker-container" data-category="<?php echo esc_attr($atts['category']); ?>" data-posts-per-page="<?php echo intval($query->query_vars['posts_per_page']); ?>" data-last-timestamp="<?php echo esc_attr($last_timestamp); ?>" style="border-left: 3px solid <?php echo esc_attr($default_color); ?>;">
    <?php while ($query->have_posts()) : $query->the_post(); ?>
        ...
        ?>
        <article class="news-ticker-entry" data-news-id="<?php the_ID(); ?>" data-timestamp="<?php echo esc_attr($date_timestamp); ?>" style="<?php echo esc_attr($bg_style); ?>" itemscope itemtype="https://schema.org/NewsArticle">
            ...
            <div class="news-ticker-content">
                ...
                <time class="news-ticker-time" datetime="<?php echo esc_attr($iso_date); ?>" itemprop="datePublished" data-full-date="<?php echo esc_attr($full_date); ?>">
